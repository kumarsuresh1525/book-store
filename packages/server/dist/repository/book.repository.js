...
let BookRepository = class BookRepository {
    ...
    async getAllBooks(filter) {
        return await this.bookModel.find(Object.assign(Object.assign(Object.assign(Object.assign({}, (filter.title && { title: { $regex: filter.title, $options: 'i' } })), (filter.author && {
